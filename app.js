...
function askQuestion(){
  ...
  console.log('User is on question'+ questions[i] + '- answer is:' + answer);
...
if( q4 === no || q === no){
 return true;
      ...
      var rightAnswers = [r,r1,r2,r3,r4];
      ...
      for(var i=0; i<questions.length; i++){
        ...
        if (questions[i] = true) {
          ...
          console.log('Alert for question \"' + questions[i]+ '\":' + rightAnswers[i] +'. ' + userPoints + ':total points.');

        }
      else
        alert(answer === wrongAlerts)[i];

        console.log('Alert for question \"' + questions[i]+ '\":' + wrongAnswers[i]+'. ' + userPoints + ':total points.');
